...
@WebServlet(name = "AdminTrackApprove", urlPatterns = "/admin_track_approve")
public class AdminTrackApproveServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (trackId != null && !trackId.isEmpty()) {
            ...
            if (track != null) {
                track.setApproved(!track.isApproved());
                trackService.updateTrack(Integer.parseInt(trackId), track);
            }
        }
        resp.sendRedirect("/admin_manage_tracks");
    }
}